    ...
    case 0: //Classification
    {
        ...
        for(int r=0; r< num_repeat_exp_; r++){
            ...
            //====================== create validation data ===============================
                ...
                // The large minority validation sample cause overfitting on small datasets
                // Commented by Ehsan 100319_1410
                                                     // TODO Try different values in addition to 0.5 - 0.7, 0.9, 1.0
//                m_VD_p = cf.sample_data(m_min_train_data, 0.5,// paramsInst->get_ms_VD_sample_size_fraction(),
//                                        paramsInst->get_cpp_srand_seed());
                ...
                m_VD_n = cf.sample_data(m_maj_train_data, paramsInst->get_ms_VD_sample_size_fraction(),
                                        paramsInst->get_cpp_srand_seed());
                std::cout << "[MC] balanced validation sample ratio" << std::endl;
...
//            std::cout << "[MC] EXIT\n" ;            exit(1);
        ...
        t_all.stop_wall_timer("[MC] Whole test including all iterations");
